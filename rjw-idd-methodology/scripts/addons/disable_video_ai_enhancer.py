#!/usr/bin/env python3
"""Disable the RJW-IDD Video AI Enhancer add-in."""
...
def _prune_ci_entries() -> None:
    ...
    target = {GHA_ENTRY, GENERIC_ENTRY}
    changed = False
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Disable the Video AI Enhancer add-in")
    parser.parse_args()
    try:
        disable_addin()
